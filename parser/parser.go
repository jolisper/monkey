...
import (
	...
	"github.com/jolisper/monkey/lexer"
...
func (p *Parser) parseLetStatement() *ast.LetStatement {
	...
	// TODO: skipping the expressions until it encounter a semicolon
...
func (p *Parser) parseExpression(precedence int) ast.Expression {
	...
	// the precedence < p.peekPrecedence() condition checks if the
	// left-binding power of the next operator/token is higher
...
// Their primary purpose is to enforce the correctness of the order of tokens
